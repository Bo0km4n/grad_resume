...
DHTは中央サーバが存在せず, 純粋なP2P型のネットワークを実現する技術であり,
...
配置数と領域の大きさを変え, リング構築をそれぞれ20回行った結果を表\ref{tabl:ring_struct}に示す.
...
\begin{figure}[htbp]
	\begin{center}
	\includegraphics[width=8cm, height=5cm]{battery_eval_3.png}
	\end{center}
	\caption{検索結果返信による消費電力}\label{fig:battery_eval}
\end{figure}
